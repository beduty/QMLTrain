...
Window {
    ...
    DelayButton {
        ...
        onProgressChanged: {
            ...
            myRpmLogger.setLog(Number(rpmCenter.rotation).toString())
        }
        onActivated: {
    ...
    Slider {
        ...
        onMoved: {
            ...
            mySpeedLogger.setLog(Number(speedCenter.rotation).toFixed(3).toString())
        }
    }
    ...
    Slider {
        ...
        onMoved: {
            ...
            myDistanceLogger.setLog(valDist.text)
        }
    }
}
